...
const account = {
  ...
  /*
   * Метод реализует проведение транзакции и меняет свойстро 
   * successful в случаи успеха на true
   * в историю транзакций будут записаны все странзакции как успешные так и нет
   * по банансу проудут тольок успешные транзакции
   * определенного типа транзакции из всей истории транзакций
   */
